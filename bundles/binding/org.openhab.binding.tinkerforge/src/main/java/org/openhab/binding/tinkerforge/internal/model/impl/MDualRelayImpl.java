 ...
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MDualRelayImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
private short relayNum;
  ...
  public void setEnabledA(AtomicBoolean newEnabledA)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MDUAL_RELAY__ENABLED_A, oldEnabledA, enabledA));
  }
  ...
  {
    if (eContainerFeatureID() != ModelPackage.MDUAL_RELAY__MBRICK) return null;
  ...
  {
    if (newMbrick != eInternalContainer() || (eContainerFeatureID() != ModelPackage.MDUAL_RELAY__MBRICK && newMbrick != null))
    {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MDUAL_RELAY__MBRICK, newMbrick, newMbrick));
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == MSubDevice.class)
    {
      switch (derivedFeatureID)
      {
        case ModelPackage.MDUAL_RELAY__SUB_ID: return ModelPackage.MSUB_DEVICE__SUB_ID;
        case ModelPackage.MDUAL_RELAY__MBRICK: return ModelPackage.MSUB_DEVICE__MBRICK;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == MSubDevice.class)
    {
      switch (baseFeatureID)
      {
        case ModelPackage.MSUB_DEVICE__SUB_ID: return ModelPackage.MDUAL_RELAY__SUB_ID;
        case ModelPackage.MSUB_DEVICE__MBRICK: return ModelPackage.MDUAL_RELAY__MBRICK;
        default: return -1;
      }
    }
  ...
  public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
  {
    if (baseClass == MBaseDevice.class)
    {
      ...
      {
        case ModelPackage.MBASE_DEVICE___INIT: return ModelPackage.MDUAL_RELAY___INIT;
        case ModelPackage.MBASE_DEVICE___ENABLE: return ModelPackage.MDUAL_RELAY___ENABLE;
        case ModelPackage.MBASE_DEVICE___DISABLE: return ModelPackage.MDUAL_RELAY___DISABLE;
        default: return -1;
      }
    }
    if (baseClass == MSubDevice.class)
