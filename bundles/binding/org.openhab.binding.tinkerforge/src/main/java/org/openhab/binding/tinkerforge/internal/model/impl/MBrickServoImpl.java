 ...
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickServoImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickServoImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickServoImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 ...
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickServoImpl#getMsubdevices <em>Msubdevices</em>}</li>
 *   <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickServoImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MBrickServoImpl extends MinimalEObjectImpl.Container implements MBrickServo
{
  ...
  public void setPosition(char newPosition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICK_SERVO__POSITION, oldPosition, position));
  }
  ...
  {
    if (eContainerFeatureID() != ModelPackage.MBRICK_SERVO__BRICKD) return null;
  ...
  {
    if (newBrickd != eInternalContainer() || (eContainerFeatureID() != ModelPackage.MBRICK_SERVO__BRICKD && newBrickd != null))
    {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICK_SERVO__BRICKD, newBrickd, newBrickd));
  }
  ...
  public EList<MServo> getMsubdevices()
  {
    if (msubdevices == null)
    {
      msubdevices = new EObjectContainmentWithInverseEList<MServo>(MSubDevice.class, this, ModelPackage.MBRICK_SERVO__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK);
    }
    return msubdevices;
  }
...
/**
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MSubDeviceHolder.class)
    {
      ...
      {
        case ModelPackage.MBRICK_SERVO__MSUBDEVICES: return ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MSubDeviceHolder.class)
    {
      ...
      {
        case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES: return ModelPackage.MBRICK_SERVO__MSUBDEVICES;
        default: return -1;
      }
    }
  ...
  public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
  {
    if (baseClass == MSubDeviceHolder.class)
    {
      ...
      {
        case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES: return ModelPackage.MBRICK_SERVO___INIT_SUB_DEVICES;
        default: return -1;
      }
    }
